# Ejercicio No.3 programa para calcular la suma, resta, multiplicacion, division, division entera, modulo y potencia de X y Y
...
print("la modulo de " + str(X) + "%" + str(Y) + " es " + str(MOD))
